...
public class MenuDragMouseEventDemo extends javax.swing.JFrame implements MenuDragMouseListener {
  ...
  // 實作MenuDragMouseListener介面之方法
  // 當於選單或選單項目上滑鼠按鍵並拖曳滑鼠時所呼叫的方法
  public void menuDragMouseDragged(MenuDragMouseEvent e) {
    System.out.println("於選單項目上按下滑鼠按鍵並拖曳滑鼠" + "  X: " + e.getX() + ", Y: " + e.getY());
  }  
  
  // 當拖曳滑鼠移至選單或選單項目時所呼叫的方法
  public void menuDragMouseEntered(MenuDragMouseEvent e) {
    System.out.println("拖曳滑鼠移至選單項目" + "  X: " + e.getX() + ", Y: " + e.getY());
  }
  
  // 當拖曳滑鼠離開選單或選單項目時所呼叫的方法
  public void menuDragMouseExited(MenuDragMouseEvent e) {
    System.out.println("拖曳滑鼠離開選單項目" + "  X: " + e.getX() + ", Y: " + e.getY());
  }
