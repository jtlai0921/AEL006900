...
public class JScrollBarDemo extends JFrame {
  ...
  public JScrollBarDemo() {
    ...
    // 設定捲軸邊框之屬性值
    UIManager.put("ScrollBar.border", new javax.swing.border.EtchedBorder(EtchedBorder.LOWERED));
    
    // 設定捲軸背景顏色之屬性值
    UIManager.put("ScrollBar.background", Color.PINK);
    
    // 取得捲軸Pluggable Look and Feel屬性值
    System.out.println("JScrollBar Look and Feel: " + UIManager.getString("ScrollBarUI"));
