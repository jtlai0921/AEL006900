...
public class JProgressBarDemo extends JFrame implements ActionListener, ChangeListener {
  ...
  ProgressRangeModel model = new ProgressRangeModel();
  ...
  public JProgressBarDemo() {
    ...
    // 以BoundedRangeModel介面建立之JProgressBar類別（MVC）Model
    jprogressbar = new JProgressBar(model);
    // 設定進度列的最小值
  ...
  public void stateChanged(ChangeEvent e) {
    System.out.println("Value: " + new Double(model.getDoubleValue()));
  }
}
