...
public class JSplitPaneDemo extends JFrame {
  ...
  public JSplitPaneDemo() {
    ...
    // 設定分隔面板邊框之屬性值
    UIManager.put("SplitPane.border", new javax.swing.border.EtchedBorder(EtchedBorder.LOWERED));
    
    // 設定分隔面板背景顏色之屬性值
    UIManager.put("SplitPane.background", Color.PINK);
    ...
    // 設定分隔面板陰影部分的顏色之屬性值
    UIManager.put("SplitPane.shadow", Color.CYAN);
    
    // 取得分隔面板Pluggable Look and Feel屬性值
    System.out.println("JSplitPane Look and Feel: " + UIManager.getString("SplitPaneUI"));
