...
public class JTabbedPaneDemo extends JFrame {
  ...
  public JTabbedPaneDemo() {
    ...
    // 設定分頁面板邊框之屬性值
    UIManager.put("TabbedPane.border", new javax.swing.border.EtchedBorder(EtchedBorder.LOWERED));
    
    // 設定文字標籤字型之屬性值
    UIManager.put("TabbedPane.font", new Font("dialog", Font.BOLD, 12));
    
    // 設定分頁面板前景之屬性值
    UIManager.put("TabbedPane.foreground", Color.PINK);
    
    // 設定分頁面板明亮部分的顏色之屬性值
    UIManager.put("TabbedPane.highlight", Color.GREEN);
    
    // 設定分頁陰影部分的顏色之屬性值
    UIManager.put("TabbedPane.tabShadow", Color.CYAN);
    
    // 取得分頁面板Pluggable Look and Feel屬性值
    System.out.println("JTabbedPane Look and Feel: " + UIManager.getString("TabbedPaneUI"));
