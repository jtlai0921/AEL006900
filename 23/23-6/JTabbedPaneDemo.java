...
public class JTabbedPaneDemo extends JFrame {
  ...
  private void createTab() {
    ...
    Component tabComponent = createTabComponent();
    ...
    // 設定第index個分頁，在分頁中，並加入component物件
    jtabbedpane.setTabComponentAt(jtabbedpane.getSelectedIndex(), tabComponent);
  ...
  private Component createTabComponent() {
    ...
    // 建立Tab Button
    btnTab = new JButton(new ImageIcon(cl.getResource("images/close.gif")));
    btnTab.setPreferredSize(new Dimension(16, 16));
    btnTab.setToolTipText("Close Tab");
    ...
    tabPanel.add(btnTab, BorderLayout.CENTER);
