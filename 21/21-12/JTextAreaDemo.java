...
public class JTextAreaDemo extends JFrame {
  ...
  String menuitemlabel[][]={
    {"New|N|new.gif", "Open|O|open.gif", "-", "Save|S|save.gif", "-", "Print|P|print.gif", "Page Setup|u|pagesetup.gif", "-", "Exit|X"},
  ...
  private void print() {
    final JTextArea printPane = jtextarea;

    if (! printPane.getText().equals("")) {
      new Thread() {
        public void run() {
          DocToPrinter doc = new DocToPrinter(printPane);
          doc.print();
        }
      }.start();
    } 
