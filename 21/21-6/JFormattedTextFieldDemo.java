...
public class JFormattedTextFieldDemo extends javax.swing.JFrame {
  ...
  public JFormattedTextFieldDemo() {
    ...
    // 設定文字欄位邊框之屬性值
    UIManager.put("FormattedTextField.border", new javax.swing.border.EtchedBorder(EtchedBorder.LOWERED));
    
    // 設定脫字符號閃爍的速率之屬性值
    UIManager.put("FormattedTextField.caretBlinkRate", 5);
    
    // 設定脫字符號的前景顏色之屬性值
    UIManager.put("FormattedTextField.caretForeground", Color.RED);
    
    // 設定文字標籤字型之屬性值
    UIManager.put("FormattedTextField.font", new Font("dialog", Font.BOLD, 12));
    
    // 設定可格式化的文字欄位前景之屬性值
    UIManager.put("FormattedTextField.foreground", Color.PINK);
    
    // 設定被選取時的背景顏色之屬性值
    UIManager.put("FormattedTextField.selectionBackground", Color.GREEN);
    
    // 設定被選取時的前景顏色之屬性值
    UIManager.put("FormattedTextField.selectionForeground", Color.CYAN);
    
    // 取得文字欄位Pluggable Look and Feel屬性值
    System.out.println("JFormattedTextField Look and Feel: " + UIManager.getString("FormattedTextFieldUI"));
