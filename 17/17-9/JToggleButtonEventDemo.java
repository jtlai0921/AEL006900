...
public class JToggleButtonEventDemo extends javax.swing.JFrame implements ChangeListener {
  ...
  public JToggleButtonEventDemo() {
    ...
    for (int i=0; i<title.length; i++) {
      ...
      // 註冊 ChangeListener
      jbutton[i].addChangeListener(this);
  ...
  public void stateChanged(ChangeEvent e) {
    ...
    for (int i=0; i < jbutton.length; i++) {
      if (e.getSource().equals(jbutton[i]))
        source = "Roll over " + jbutton[i].getToolTipText() + " Toggle Button";
    }
