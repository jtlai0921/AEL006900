...
public class JRadioButtonEventDemo extends javax.swing.JFrame implements ChangeListener {
  ...
  public JRadioButtonEventDemo() {
    ...
    for (int i=0; i<5; i++) {
      ...
      // 註冊 ChangeListener
      jradiobutton[i].addChangeListener(this);
    }
    ...
    // 註冊 ChangeListener
    jradiobutton[5].addChangeListener(this);
    ...
    // 註冊 ChangeListener
    jradiobutton[6].addChangeListener(this);
  ...
  public void stateChanged(ChangeEvent e) {
    ...
    for (int i=0; i < jradiobutton.length; i++) {
      if (e.getSource().equals(jradiobutton[i]))
        source = "Roll over " + jradiobutton[i].getText();
    }
