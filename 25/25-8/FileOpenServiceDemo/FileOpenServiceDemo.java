...
public class FileOpenServiceDemo extends javax.swing.JFrame {
  ...
  public static void main(String[] args) {
    ...
    new FileOpenServiceDemo();
  }

  // 建構函式
  public FileOpenServiceDemo() {
    super("JNLP FileOpenService");
  ...
  private void menu_actionPerformed(ActionEvent e) {
    if (e.getActionCommand().equals(item[0])) { // new
      ...
      JOptionPane.showMessageDialog(null, "JNLP FileOpenService", "About", JOptionPane.INFORMATION_MESSAGE);
    }
  }
