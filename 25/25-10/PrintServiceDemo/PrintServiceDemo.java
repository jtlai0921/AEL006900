...
public class PrintServiceDemo extends javax.swing.JFrame {
  ...
  // 建構函式
  public PrintServiceDemo() {
    super("JNLP PrintService");
  ...
  private void menu_actionPerformed(ActionEvent e) {
    if (e.getActionCommand().equals(item[0])) { // new
      ...
      JOptionPane.showMessageDialog(null, "JNLP PrintService", "About", JOptionPane.INFORMATION_MESSAGE);
    }
  }
