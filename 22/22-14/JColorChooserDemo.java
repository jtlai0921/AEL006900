...
public class JColorChooserDemo extends JFrame implements ChangeListener {
  ...
  public JColorChooserDemo() {
    ...
    // 設定選擇顏色的邊框之屬性值
    UIManager.put("ColorChooser.selectedColorBorder", new javax.swing.border.EtchedBorder(EtchedBorder.LOWERED));

    // 設定色彩對話盒前景之屬性值
    UIManager.put("ColorChooser.foreground", Color.PINK);

    // 取得色彩對話盒的Look and Feel屬性值
    System.out.println("JColorChooser Look and Feel: " + UIManager.getString("ColorChooserUI"));
