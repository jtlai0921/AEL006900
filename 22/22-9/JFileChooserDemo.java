...
public class JFileChooserDemo extends JFrame {
  ...
  private void open() {
    ...
    filter[0] = new CustomFileFilter("WAV Files" , "wav");
    filter[1] = new CustomFileFilter("AU Files"  , "au");
    filter[2] = new CustomFileFilter("AIF Files" , "aif");
    filter[3] = new CustomFileFilter("AIFF Files", "aiff");
    ...
    // 設定檔案輔助區域中之自訂物件
    jfilechooser.setAccessory(new AudioAccessory(jfilechooser));
