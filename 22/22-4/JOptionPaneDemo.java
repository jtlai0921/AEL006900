...
public class JOptionPaneDemo extends JFrame implements ActionListener {
  ...
  public JOptionPaneDemo() {
    ...
    // 設定對話框邊框之屬性值
    UIManager.put("OptionPane.border", new javax.swing.border.EtchedBorder(EtchedBorder.LOWERED));

    // 設定錯誤訊息的圖像
    UIManager.put("OptionPane.errorIcon", new ImageIcon(cl.getResource("images/error.gif")));

    // 設定一般訊息的圖像
    UIManager.put("OptionPane.informationIcon", new ImageIcon(cl.getResource("images/information.gif")));

    // 設定詢問訊息的圖像
    UIManager.put("OptionPane.questionIcon", new ImageIcon(cl.getResource("images/question.gif")));

    // 設定警告訊息的圖像
    UIManager.put("OptionPane.warningIcon", new ImageIcon(cl.getResource("images/warning.gif")));

    // 取得對話框Pluggable Look and Feel屬性值
    System.out.println("JOptionPane Look and Feel: " + UIManager.getString("OptionPaneUI"));
