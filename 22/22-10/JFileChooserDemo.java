...
public class JFileChooserDemo extends JFrame {
  ...
  private void open() {
    ...
    // 處理篩選條件（Filter）
    CustomFileFilter[] filter = new CustomFileFilter[7];
    
    filter[0] = new CustomFileFilter("AVI Files" , "avi");
    filter[1] = new CustomFileFilter("MIDI Files", "midi");
    filter[2] = new CustomFileFilter("MOV Files" , "mov");
    filter[3] = new CustomFileFilter("MP3 Files" , "mp3");
    filter[4] = new CustomFileFilter("MPEG Files", "mpeg");
    filter[5] = new CustomFileFilter("WAV Files" , "wav");
    filter[6] = new CustomFileFilter("WMA Files" , "wma");
    ...
    // 設定檔案輔助區域中之自訂物件
    jfilechooser.setAccessory(new MediaAccessory(jfilechooser));
