...
public class TableColumnModelEventDemo extends JFrame implements TableColumnModelListener { // 實作TableColumnModelListener介面 
  ...
  public static void main(String[] args) {
    ...
    new TableColumnModelEventDemo();
  }
    
  // 建構函式
  public TableColumnModelEventDemo() {
    super("Table Column Model Event Demo");
  ...
  // 實作TableColumnModelListener介面之方法
  // 當新增直行至Table Column Model時
  ...
  public void columnMoved(TableColumnModelEvent e) {
    System.out.println("索引值由" + e.getFromIndex() + "移至"  + e.getToIndex());
  }

  // 當移動直行索引值時
  public void columnRemoved(TableColumnModelEvent e) {}
  
  // 當Table Column Model的選擇模型改變時
  public void columnSelectionChanged(ListSelectionEvent e) {
    ...
    if (!adjust) {
      ...
      // 取得被選取項目的索引值
      int mode = source.getSelectionMode();
      
      if (mode == ListSelectionModel.SINGLE_SELECTION)
        System.out.println("單選模式");    
      else if (mode == ListSelectionModel.SINGLE_INTERVAL_SELECTION)
        System.out.println("可選擇單一區間，但此區間內可選擇多個項目");    
      else if (mode == ListSelectionModel.MULTIPLE_INTERVAL_SELECTION)
        System.out.println("多重區間選擇模式"); 

      System.out.println("Min Selection Index: " + source.getMinSelectionIndex()); 
      System.out.println("Max Selection Index: " + source.getMaxSelectionIndex()); 
    }
  }
  ...
  private void menu_actionPerformed(ActionEvent e) {
    ...
    if (jmenuitem.getText().equals("Print")) { // Print
      ...
      JOptionPane.showMessageDialog(null, "Table Column Model Event Demo", "About", JOptionPane.INFORMATION_MESSAGE);
    }
  }
