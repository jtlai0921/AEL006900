...
public class JTreeDemo extends JFrame {
  ...
  public JTreeDemo() {
    ...
    // 設定樹狀物件前景之屬性值
    UIManager.put("Tree.foreground", Color.PINK);
    
    // 設定樹狀物件文字標籤字型之屬性值
    UIManager.put("Tree.font", new Font("dialog", Font.BOLD, 12));
    ...
    // 取得樹狀物件Pluggable Look and Feel屬性值
    System.out.println("JTree Look and Feel: " + UIManager.getString("TreeUI"));
