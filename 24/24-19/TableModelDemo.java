...
public class TableModelDemo extends JFrame {
  ...
  public TableModelDemo() {
    ...
    final String[] columnheader = {"Customer ID", "Customer Name", "Product ID", "Category ID", "Quantity Per Unit", "Price"};
  ...
  private void menu_actionPerformed(ActionEvent e) {
    ...
    if (jmenuitem.getText().equals("Print")) { // Print
      ...
      JOptionPane.showMessageDialog(null, "Table Model Demo", "About", JOptionPane.INFORMATION_MESSAGE);
    }
  }
