...
public class ListSelectionEventDemo extends JFrame implements ListSelectionListener { // 實作ListSelectionListener介面 
  ...
  public static void main(String[] args) {
    ...
    new ListSelectionEventDemo();
  }
    
  // 建構函式
  public ListSelectionEventDemo() {
    super("List Selection Event Demo");
  ...
  private void menu_actionPerformed(ActionEvent e) {
    ...
    if (jmenuitem.getText().equals("Print")) { // Print
      ...
      JOptionPane.showMessageDialog(null, "List Selection Event Demo", "About", JOptionPane.INFORMATION_MESSAGE);
    }
  }
