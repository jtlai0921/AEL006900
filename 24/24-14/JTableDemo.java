...
public class JTableDemo extends JFrame implements MouseListener { // 實作MouseListener介面 
  ...
  public JTableDemo() {
    ...
    // 設定表格前景之屬性值
    UIManager.put("Table.foreground", Color.PINK);
    
    // 設定表格文字標籤字型之屬性值
    UIManager.put("Table.font", new Font("dialog", Font.BOLD, 12));
    ...
    // 設定被選取時的前景顏色
    UIManager.put("able.selectionForeground", Color.BLUE);

    // 設定表格標題的字型
    UIManager.put("TableHeader.font", new Font("Verdana", Font.PLAIN | Font.ITALIC, 12));
    ...
    // 取得表格Pluggable Look and Feel屬性值
    System.out.println("JTable Look and Feel: " + UIManager.getString("TableUI"));
