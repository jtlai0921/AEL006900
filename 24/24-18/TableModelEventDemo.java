...
public class TableModelEventDemo extends JFrame implements TableModelListener { // 實作TableModelListener介面 
  ...
  public static void main(String[] args) {
    ...
    new TableModelEventDemo();
  }
    
  // 建構函式
  public TableModelEventDemo() {
    super("Table Model Event Demo");
  ...
  // 實作TableModelListener介面之方法
  // 當Table Model之行列或單元改變時
  public void tableChanged(TableModelEvent e) {
    ...
    System.out.println(columnName + "的第" + row + "列的值被改為" + data);
  }
  ...
  private void menu_actionPerformed(ActionEvent e) {
    ...
    if (jmenuitem.getText().equals("Print")) { // Print
      ...
      JOptionPane.showMessageDialog(null, "Table Model Event Demo", "About", JOptionPane.INFORMATION_MESSAGE);
    }
  }
