...
public class TreeSelectionEventDemo extends JFrame {
  // Main method
  public static void main(String[] args) {
    ...
    new TreeSelectionEventDemo();
  }

  // 建構函式
  public TreeSelectionEventDemo() {
    this.setTitle("Tree Selection Event Demo");
    // 取得目前之Class Loader
    ...
    jmenuAbout.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        JOptionPane.showMessageDialog(null, "Tree Selection Event Demo", "About", JOptionPane.INFORMATION_MESSAGE);
      }
    });
